  ...
  methods: {
    async getArticulo() {
      if (this.query.length > 0) {
        var art = await global_.postQuery("/api/articulo", { query: this.query });
        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header pb-0">
              <h5>Consulte</h5>
              <span>Digite Codigo Alternativo, Cod Barra, Nombre</span>
            </div>
            <hr />
            <div class="card-body pt-0">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12 col-md-4 col-lg-4">
                    <div class="row">
                      ...
                      <div class="col-sm-12 col-md-6 col-lg-6">
                        <div v-if="scannerIsRunning == false" class="btn-mb">
                          <button
              ...
              <div v-show="scannerIsRunning == true" class="row">
                <div class="col-sm-12 col-md-12 col-lg-12" style="background: red">
                  <div id="camara"></div>
                </div>
              </div>
              <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
                  <div class="table-responsive">
                    ...
                    <span class="text-warning"
                      >item encontrados : {{ articulos.length }}</span
                    >
                    <table class="table table-bordernone">
                      ...
                      <tbody>
                        <tr v-for="articulo in articulos" :key="articulo.artId">
                          ...
                          <td>
                            <div class="media">
                              ...
                              <div class="media-body">
                                ...
                                > -->
                                <span>{{ articulo.artNombre }}</span>
                              </div>
                            </div>
                          </td>
                          <td>
                            <p>{{ articulo.artPrecioVenta }} Bs.</p>
                          </td>
                          <td>
                            <p>{{ articulo.artPrecioVentaDos }} Bs.</p>
                          </td>
                          <td>
                            <p>{{ articulo.artPrecioVentaTres }} Bs.</p>
                          </td>
                          <td>
                            <p>{{ articulo.monId }}</p>
                          </td>
            ...
            <div class="card-body">
              <form method="POST">
                <div class="row">
                  <div class="col-sm-12 col-md-6 col-lg-6">
                    <div class="form-group">
                      <label for="artId">Codigo Alternativo</label>
                      <input
                        v-model="form.artId"
                        class="form-control"
                        id="artId"
                  ...
                  <div class="col-sm-12 col-md-6 col-lg-6">
                    <div class="form-group">
                      <label for="artNombre">Nombre del Articulo</label>
                      <input
                ...
                <div class="row">
                  <div class="col-sm-12 col-md-4 col-lg-4">
                    <div class="form-group">
                      <label for="artPrecioVenta">Precio Venta I</label>
                      <input
                  ...
                  <div class="col-sm-12 col-md-4 col-lg-4">
                    <div class="form-group">
                      <label for="artPrecioVentaDos">Precio Venta II</label>
                      <input
                  ...
                  <div class="col-sm-12 col-md-4 col-lg-4">
                    <div class="form-group">
                      <label for="artPrecioVentaTres">Precio Venta III</label>
                      <input
                        v-model="form.artPrecioVentaTres"
                        class="form-control digits"
                ...
                <div>
                  <div class="text-end btn-mb">
                    <button class="btn btn-primary" type="button">
                      <i class="fa-solid fa-newspaper"></i> {{ titleForm }}
                    </button>
                  </div>
                </div>
